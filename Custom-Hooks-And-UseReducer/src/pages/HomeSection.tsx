...
const HomeSection = () => {
  return (
    <div className='flex justify-center align-center items-center h-[100vh]'>
        ...
        <a href='/loading' className='my-4 text-base text-blue-500 font-semibold underline'> useToggle  </a>
        <a href='/clock' className='my-4 text-base text-blue-500 font-semibold underline'> useReducer </a>
